...
public class Rectangle {
    ...
    public void setWidth(double width) {
        if(width <= 0){
            System.err.println("Width cannot be set to negative or zero values.");
            System.exit(1);
        }
        this.width = width;
    }
    ...
    public void setLength(double length) {
        if(length <= 0){
            System.err.println("length cannot be set to negative or zero values.");
            System.exit(1);
        }
        this.length = length;
    }
...
2. Create a custom class named Rectangle with the following specifications:
	...
	Create another class named RectangleClients, create multiple rectangle objects, and test each
	function of the rectangle object.
 */