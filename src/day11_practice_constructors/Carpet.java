...
2. Create a custom class named Carpet with the following specifications:
    ...
    Actions:
		calcCost(): calculate the total cost of the carpet and return it as a double.
   		toString(): display all the info of the carpet, including the total cost of the carpet as
   ...
   Price calculation formula:
    ...
    Create another class named CarpetClients, create multiple carpet objects, and test each function
    of the carpet object.
 */