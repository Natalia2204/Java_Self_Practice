...
public class Items {
    public static void main(String[] args) {
        ...
        System.out.println("first index number of \"Gloves\": " + Arrays.binarySearch(items,"Gloves" ));
        ...
        // 5.4 Print the report for each shopping item in the format: name - price - #ID
